...
var NumberplateRemote=function(){
   ...
   document.getElementById("submitButton").disabled = true; //disable button onsubmit
    ...
    $.get("/uploadrego", data,function(result) {
      ...
      document.getElementById("submitButton").disabled = false;  //reenable submit button along with results
...
var ImageuploadRemote=function(){
  ...
  var data={
    ...
    $("#result").html('Loading - Please Wait');
    $("body").css("cursor", "progress");
   // document.getElementById("submitButton2").disabled = true; //disable Validate Image button 

 //   this is our ajax call
    $.post("/upload", data,function(result) {
       $("#result").html(result);
        $("body").css("cursor", "default");
        //document.getElementById("submitButton2").disabled = false;//reenable Validate Image button 
...
$(document).ready(function(e){
  ...
  $("#captureimage").on('submit',(function(e) {
    ...
    document.getElementById("submitButton2").disabled = true; //disable Validate Image button 
      ...
      $("#result").css('opacity','1');
      $("body").css("cursor", "default");
      document.getElementById("submitButton2").disabled = false; //disable Validate Image button 
